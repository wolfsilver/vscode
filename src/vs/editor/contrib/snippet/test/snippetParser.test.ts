...
suite('SnippetParser', () => {
	...
	test('Parser, default placeholder values', () => {
		...
		assert.strictEqual((<Text>(<Placeholder>p1).children[0]).value, 'err');

		assert.strictEqual((<Placeholder>p2).index, 1);
		assert.strictEqual((<Placeholder>p2).children.length, 1);
		assert.strictEqual((<Text>(<Placeholder>p2).children[0]).value, 'err');
	});
	...
	test('Parser, default placeholder values and one transform', () => {
		...
		assert.strictEqual((<Text>(<Placeholder>p3).children[0]).value, 'err');
		...
		assert.strictEqual((<Text>(<Placeholder>p4).children[0]).value, 'err');
